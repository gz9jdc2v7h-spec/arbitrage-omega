...
export const INITIAL_POOLS: PoolInfo[] = [
  ...
  // ── Flashloan Base Capital Providers ──────────────────────────────────────
  {
    id: 'pool_aave_v3_flash_provider',
    name: 'Aave V3 Polygon Flash Loan Provider',
    protocol: 'AAVE_V3',
    ...
    token1: POLYGON_TOKENS.WETH,
    feeBps: 5,
    reserve0USD: 28900000,
    reserve1USD: 22400000,
    isFundingPool: true,
    status: 'ACTIVE',
  },
  {
    id: 'pool_univ3_usdc_usdt_flash',
    name: 'Uniswap V3 USDC.e/USDT Direct Pool Flash',
    protocol: 'V3_CLMM',
    protocolArchitecture: 'Uniswap V3 Concentrated Liquidity Direct Flash',
    category: 'FUNDING_FLASHLOAN',
    ...
    reserve0USD: 6200000,
    reserve1USD: 6180000,
    sqrtPriceX96: '79230074289232050048141107070',
    liquidity: '1104829301938492019',
    activeTick: -2,
    isFundingPool: true,
    status: 'ACTIVE',
  },

  // ── Liquidation Associated Borrower Markets ────────────────────────────────
  {
    id: 'pool_aave_v3_weth_usdc',
    name: 'Aave V3 WETH/USDC Borrower Market',
    protocol: 'AAVE_V3',
  ...
  {
    id: 'pool_aave_v3_wbtc_usdt',
    name: 'Aave V3 WBTC/USDT Borrower Market',
    protocol: 'AAVE_V3',
    protocolArchitecture: 'Aave V3 Lending Market — Liquidation Target',
    category: 'LIQUIDATION_TARGET',
